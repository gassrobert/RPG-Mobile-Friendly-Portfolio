...
<article id="post-<?php the_ID(); ?>" <?php post_class('rpgportfolio-format-image'); ?>>
		...
		<div class="inner-rpgportfolio-format-image">
			...
			<header class="entry-header background-image-smartphone" style="background-image: url(<?php echo rpg_portfolio_get_attachment(); ?>); background-size: cover; background-repeat: no-repeat; background-position: left top; height: <?php echo ($image_attributes["height"]  * .3); ?>px; width: <?php echo ($image_attributes["width"]  * .3); ?>px; margin: 0 auto;">
